...
sc = SparkContext(appName = "task2b")
...
schema_over_ten = schema_temp_year.groupBy('year', 'month').agg(F.countDistinct('yearmonth', 'station').alias('count')).orderBy('count', ascending=False).show()
