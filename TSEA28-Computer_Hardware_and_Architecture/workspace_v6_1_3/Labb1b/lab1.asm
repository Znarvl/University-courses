...
correctcode:
	...
	bl clearinput
resettimer:
	mov r2, #0xB400 ; Create timer for 5s ( 4C4 B400 = 80 000 000 = 16 000 000)
	movt r2, #0x4C4 ; -||-
waitkeypress2:
	mov r1,#(GPIOB_GPIODATA & 0xffff)
	movt r1,#(GPIOB_GPIODATA >> 16)

	sub r2,r2,#12 ; Count down timer
	cmp r2, #50
	bls restart
	...
	;; RESET, COMPARE
waitkeyrelease2:
	;sub r2,r2,#1 ; Count down timer

	ldr r0, [r1]
	ands r0, #0x10 ; check if the strobe has turned off
	bne waitkeyrelease2 ; -||-
