...
t1 = convert_time("12:00")
t2 = convert_time("14:00")

t3 = convert_time ("14:00")
t4 = convert_time("15:00")

span1 = new_time_span(t1,t2)
span2 = new_time_span(t3,t4)
o = overlap(span1,span2)
print(o)
