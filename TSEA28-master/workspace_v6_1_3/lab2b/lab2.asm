...
; Constants
POINTSL .equ 0x20001000
POINTSR .equ 0x20001004
RIKTNING .equ 0x20001008
SERVE .equ 0x2000100C
SPEED .equ 0x2001010
...
reset:
	; RESET VALUES
	mov r0,#(POINTSL & 0xffff)
	movt r0, #(POINTSL >> 16)

	mov r1, #0x00
	str r1,[r0]

	mov r0,#(POINTSR & 0xffff)
	movt r0, #(POINTSR >> 16)
...
intgpiod: ; Here is the interrupt routine triggered by port D
	;push{lr, r0, r1}
	push{lr}
