...
def new_cases():
    ...
    new_test_case(
        ...
        "00:00",
        "23:00",
        ["08:00-09:00", "11:00-12:36", "15:00-15:12"],
        ["00:00-08:00", "09:00-11:00", "12:36-15:00","15:12-23:00"])
    ...
    #Appointment start before starttime
    new_test_case(
        5,
        "08:00",
        "13:00",
    ...
    new_test_case(
     ...
     #Appointment start and end at same time
    new_test_case(
        7,
        "09:00",
        "17:00",
        ["09:00-10:00", "10:00-13:00"],
        ["13:00-17:00"])

    #Appointment after end time
    new_test_case(
        8,
        "08:00",
        "17:00",
    ...
    #Multiple appointments outside of time span
    new_test_case(
        10,
        "14:00",
        "16:00",
        ["02:00-03:00", "04:00-05:00", "15:00-16:00" , "11:00-12:00", "17:00-18:00", \
         "22:00-23:00"],
        ["14:00-15:00"])
