...
class TestEvalProgram(TestCase):
    ...
    _print_and_set_a_prog = ['calc', ['print', 'a'], ['set', 'a']]
    ...
    def testReturnValue(self):
        ...
        """
        new_vars = lab6.eval_program(self._set_a_prog)
        self.assertEqual(new_vars, {"a": 7})
        self._input.setInputFeed([10])
        new_vars = lab6.eval_program(self._input_a_prog)
    ...
    def testDestructiveness(self):
        ...
        """
        my_vars = {'a': 5}
        new_vars = lab6.eval_program(self._set_a_prog, my_vars)
        self.assertEqual(my_vars, {'a': 5})
        self.assertIsNot(my_vars, new_vars)
        self._input.setInputFeed([10])
        new_vars = lab6.eval_program(self._input_a_prog, my_vars)
        self.assertEqual(my_vars, {'a': 5})
        self.assertIsNot(my_vars, new_vars)
        new_vars = lab6.eval_program(self._print_and_set_a_prog, my_vars)
        self.assertEqual(my_vars, {'a': 5})
        self.assertIsNot(my_vars, new_vars)
    ...
    def testIO(self):
        ...
        lab6.eval_program(self._read_and_print_a_prog)
    ...
    def testIf(self):
        ...
        new_vars = lab6.eval_program(self._if_prog)
    ...
    def testLoop(self):
        ...
        new_vars = lab6.eval_program(self._loop_prog)
